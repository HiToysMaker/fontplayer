<script setup lang="ts">
  ...
  import { tool, grid, background, setCanvas, canvas, fontRenderStyle, setTool, checkJoints, checkRefLines, setGlyphDraggerTool, glyphDraggerTool } from '../../stores/global'
