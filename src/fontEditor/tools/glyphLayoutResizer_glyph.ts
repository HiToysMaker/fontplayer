...
import {
	selectControl,
} from '../../fontEditor/stores/glyphLayoutResizer_glyph'
import { ICustomGlyph, RectLayoutParams, getRatioLayout, executeScript, editGlyph } from '../stores/glyph'
import { emitter } from '../Event/bus'
import { SubComponentsRoot, selectedComponent } from '../stores/glyph'
...
const initLayoutResizer = (canvas: HTMLCanvasElement) => {
	...
	let lastY = -1
	let mousedown = false
	const _editGlyph = SubComponentsRoot.value ? SubComponentsRoot.value.value : editGlyph.value
