...
const computeParamsByJoints = (jointsMap) => {
  ...
  const h2 = range(skeleton_9.y - skeleton_8.y, h2_range)
  const w1 = range(skeleton_7.x - skeleton_1.x, w1_range)
  return {
    h1,
    h2,
    w1,
...
const updateGlyphByParams = (params, global_params) => {
  ...
  const skeleton_8 = new FP.Joint('skeleton_8', {
    x: skeleton_4.x + w1 * 0.25,
    y: skeleton_4.y - h1 * 0.25,
  })
...
const getComponents = (skeleton, global_params) => {
  ...
  const { out_stroke1_curves, out_stroke1_points, in_stroke1_curves, in_stroke1_points } = FP.getCurveContours2(
    ...
    [
      ...
      { start: skeleton_6, bend: skeleton_7, end: skeleton_0 },
    ],
    weight
  )
  const { out_stroke2_start, out_stroke2_end, in_stroke2_start, in_stroke2_end } = FP.getLineContours('stroke2', { stroke2_start: skeleton_8, stroke2_end: skeleton_9 }, weight)
