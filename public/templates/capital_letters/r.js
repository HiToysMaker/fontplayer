...
const getComponents = (skeleton, global_params) => {
  ...
  const { out_stroke3_start, out_stroke3_end, in_stroke3_start, in_stroke3_end } = FP.getLineContours('stroke3', { stroke3_start: skeleton_6, stroke3_end: skeleton_7 }, weight)
