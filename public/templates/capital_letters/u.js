...
const computeParamsByJoints = (jointsMap) => {
  ...
  const h1 = range(skeleton_4.y - skeleton_6.y, h1_range)
  const h2 = range(skeleton_4.y - skeleton_5.y, h2_range)
  const w1 = range(skeleton_6.x - skeleton_0.x, w1_range)
  return {
    h1,
    h2,
    w1,
...
const updateGlyphByParams = (params, global_params) => {
  ...
  glyph.addRefLine(refline(skeleton_4, skeleton_2))
...
const getComponents = (skeleton, global_params) => {
  ...
  const { out_stroke3_start, out_stroke3_end, in_stroke3_start, in_stroke3_end } = FP.getLineContours('stroke3', { stroke3_start: skeleton_6, stroke3_end: skeleton_5 }, weight)
