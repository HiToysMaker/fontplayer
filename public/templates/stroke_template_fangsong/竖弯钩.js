...
const getComponents = (skeleton) => {
  ...
  const out_radius_start_shu_wan = FP.getPointOnLine(out_shu_end, out_shu_start, out_radius_shu_wan)
  ...
  const end_p2_p1_vector = FP.turnAngleFromStart(in_gou_end, in_radius_end_wan_gou, FP.degreeToRadius(8), 100)
