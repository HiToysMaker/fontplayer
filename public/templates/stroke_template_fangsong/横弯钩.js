...
const getComponents = (skeleton) => {
  ...
  const end_p0 = FP.goStraight(in_radius_control, in_radius_end, d)
  const end_p0_p1_vector = FP.turnLeft(in_radius_end, end_p0, 100)
  const end_p2 = out_gou_end
  const end_p2_p1_vector = FP.turnAngleFromStart(out_gou_end, out_radius_end, FP.degreeToRadius(15), 100)
  ...
  pen.quadraticBezierTo(end_p1.x, end_p1.y, out_gou_end.x, out_gou_end.y)
