...
const computeParamsByJoints = (jointsMap) => {
  ...
  const h3 = range(skeleton_11.y - skeleton_9.y, h3_range)
  const h4 = range(skeleton_6.y - skeleton_7.y, h4_range)
  const h5 = range(skeleton_4.y - skeleton_3.y, h5_range)
  const w1 = range(skeleton_3.x - skeleton_1.x, w1_range)
  const w2 = range(skeleton_6.x - skeleton_7.x, w2_range)
  return {
    h1,
    h2,
    h3,
...
const getComponents = (skeleton, global_params) => {
  ...
  const joint_1 = new FP.Joint('joint_1', in_stroke1_curves[in_stroke1_curves.length - 1].end)
  //const joint_2 = FP.Joint('joint_2', in_stroke1_curves[in_stroke1_curves.length - 1].end)
  glyph.addJoint(joint_1)
  //glyph.addJoint(joint_2)
