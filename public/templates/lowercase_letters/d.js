...
const computeParamsByJoints = (jointsMap) => {
  ...
  const h3 = range(skeleton_2.y - skeleton_3.y, h3_range)
  const w1 = range(skeleton_1.x - skeleton_7.x, w1_range)
  const w2 = range(skeleton_2.x - skeleton_3.x, w2_range)
  return {
    h1,
    h2,
    h3,
...
const updateGlyphByParams = (params, global_params) => {
  ...
  const skeleton_6 = new FP.Joint('skeleton_6', {
    x: skeleton_5.x,
    y: skeleton_5.y + (h1 - h2) / 2 - weight / 4,
  })
  const skeleton_7 = new FP.Joint('skeleton_7', {
    x: skeleton_5.x,
    y: skeleton_5.y + (h1 - h2) - weight / 2,
  })
  ...
  const skeleton_9 = new FP.Joint('skeleton_9', {
    x: skeleton_1.x - w2,
    y: skeleton_1.y - weight / 2,
  })
  const skeleton_10 = new FP.Joint('skeleton_10', {
    x: skeleton_1.x,
    y: skeleton_1.y - h3 - weight / 2,
  })
  const skeleton = {
    skeleton_0,
    skeleton_1,
