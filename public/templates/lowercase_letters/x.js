...
const getComponents = (skeleton, global_params) => {
  ...
  const p0_joint = new FP.Joint('p0_joint', stroke1_start_serif_p0)
  const p1_joint = new FP.Joint('p1_joint', stroke1_start_serif_p1)
  const p2_joint = new FP.Joint('p2_joint', stroke1_start_serif_p2)
  const p3_joint = new FP.Joint('p3_joint', stroke1_start_serif_p3)
  const p4_joint = new FP.Joint('p4_joint', stroke1_start_serif_p4)
  const p5_joint = new FP.Joint('p1_joint', stroke1_start_serif_p5)
  const p6_joint = new FP.Joint('p6_joint', stroke1_start_serif_p6)
  const p7_joint = new FP.Joint('p7_joint', stroke1_start_serif_p7)
  const p4_before_joint = new FP.Joint('p4_before_joint', stroke1_start_serif_p4_before)
  const p4_after_joint = new FP.Joint('p4_after_joint', stroke1_start_serif_p4_after)
  const p5_before_joint = new FP.Joint('p5_before_joint', stroke1_start_serif_p5_before)
  const p5_after_joint = new FP.Joint('p5_after_joint', stroke1_start_serif_p5_after)
  ...
  glyph.addJoint(p4_before_joint)
  glyph.addJoint(p4_after_joint)
  glyph.addJoint(p5_before_joint)
  glyph.addJoint(p5_after_joint)
