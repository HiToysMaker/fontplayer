...
const y0 = ascender - descender - params.h1 + params.h3 + global_params.weight / 2
...
const computeParamsByJoints = (jointsMap) => {
  const { skeleton_0, skeleton_1, skeleton_2, skeleton_3, skeleton_4, skeleton_5, skeleton_6, skeleton_7, skeleton_8, skeleton_9, skeleton_10, skeleton_11, skeleton_12, skeleton_13 } = jointsMap
  ...
  const h2 = range(skeleton_7.y - skeleton_1.y, h2_range)
  const h3 = range(skeleton_7.y - skeleton_8.y, h3_range)
  const h4 = range(skeleton_11.y - skeleton_12.y, h4_range)
  const h5 = range(skeleton_9.y - skeleton_13.y, h5_range)
...
const updateGlyphByParams = (params, global_params) => {
  const { h1, h2, h3, h4, h5, w1 } = params
  ...
  glyph.addRefLine(refline(skeleton_14, skeleton_0))
