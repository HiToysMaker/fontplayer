...
const computeParamsByJoints = (jointsMap) => {
  ...
  const w1 = range(skeleton_1.x - skeleton_2.x, w1_range)
  return {
    h1,
    w1,
  }
...
const getComponents = (skeleton, global_params) => {
  ...
  const { out_stroke1_start, out_stroke1_end, in_stroke1_start, in_stroke1_end } = FP.getLineContours('stroke1', { stroke1_start: skeleton_0, stroke1_end: skeleton_1_1 }, weight)
  const { out_stroke2_start, out_stroke2_end, in_stroke2_start, in_stroke2_end } = FP.getLineContours('stroke2', { stroke2_start: skeleton_1_2, stroke2_end: skeleton_2 }, weight)
