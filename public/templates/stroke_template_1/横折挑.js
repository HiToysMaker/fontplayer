...
const getComponents = (skeleton) => {
  ...
  const start_p10 = FP.getPointOnLine(in_heng_start, in_heng_end, start_length)
  const start_p9 = FP.turnLeft(in_heng_end, start_p10, 2 * d)
  ...
  let { corner: tiao_control } = FP.getIntersection(
    { type: 'line', start: out_corner_zhe_tiao, end: out_tiao_end },
    { type: 'line', start: in_tiao_end, end: tiao_vecter_end },
  )
  if (!FP.isPointOnLineSegment(tiao_control, out_corner_zhe_tiao, out_tiao_end)) {
