...
const getComponents = (skeleton) => {
  ...
  const end_p10 = FP.getPointOnLine(out_wan_end, out_wan_start, end_length)
  const end_p9 = FP.turnRight(out_wan_start, end_p10, 2 * d)
  ...
  const end_p2 = FP.turnRight(end_p4, end_p3, 1.3 * d)
