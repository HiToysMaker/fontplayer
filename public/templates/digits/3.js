  ...
  switch (draggingJoint.name) {
    case 'skeleton_1': {
      ...
      jointsMap['skeleton_7'] = {
        ...
        y: glyph.tempData['skeleton_7'].y + deltaY / 4,
      }
    ...
    case 'skeleton_8': {
      ...
      jointsMap['skeleton_7'] = {
        x: glyph.tempData['skeleton_7'].x + deltaX,
        y: glyph.tempData['skeleton_7'].y + deltaY / 2 + deltaY / 4,
      }
      jointsMap['skeleton_8'] = {
        x: glyph.tempData['skeleton_8'].x + deltaX,
...
const computeParamsByJoints = (jointsMap) => {
  ...
  const h1 = range(skeleton_8.y - skeleton_3.y, h1_range)
  const h2 = range(skeleton_0.y - skeleton_1.y, h2_range)
  const w1 = range(skeleton_3.x - skeleton_1.x, w1_range)
  const w2 = range(skeleton_5.x - skeleton_6.x, w2_range)
  return {
    h1,
    h2,
    w1,
...
const updateGlyphByParams = (params, global_params) => {
  ...
  glyph.addRefLine(refline(skeleton_5, skeleton_8))
