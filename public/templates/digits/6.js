...
const ox = 500
const oy = 500
const x0 = 500 - width / 2 + params.w2
...
const computeParamsByJoints = (jointsMap) => {
  ...
  const h2 = range(skeleton_3.y - skeleton_9.y, h2_range)
  const h3 = range(skeleton_9.y - skeleton_1.y, h3_range)
  const w1 = range(skeleton_5.x - skeleton_3.x, w1_range)
...
const updateGlyphByParams = (params, global_params) => {
  ...
  const skeleton_1 = new FP.Joint('skeleton_1', {
    x: skeleton_0.x - w2,
    y: skeleton_0.y + h1 - h2 - h3,
  })
  const skeleton_2 = new FP.Joint('skeleton_2', {
    x: skeleton_1.x,
    y: skeleton_0.y + h1 - h2 / 2
  })
  ...
  glyph.addRefLine(refline(skeleton_9, skeleton_3))
  glyph.addRefLine(refline(skeleton_9, skeleton_7))
  glyph.addRefLine(refline(skeleton_7, skeleton_5))
  glyph.addRefLine(refline(skeleton_5, skeleton_3))
...
const getComponents = (skeleton, global_params) => {
  ...
  const { out_stroke2_curves, out_stroke2_points, in_stroke2_curves, in_stroke2_points } = FP.getCurveContours2(
    'stroke2',
    [
      { start: skeleton_2, bend: skeleton_9, end: skeleton_8 },
      { start: skeleton_8, bend: skeleton_7, end: skeleton_6 },
      { start: skeleton_6, bend: skeleton_5, end: skeleton_4 },
      { start: skeleton_4, bend: skeleton_3, end: skeleton_2 },
    ],
    weight
  )
