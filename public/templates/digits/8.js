...
const getJointsMap = (data) => {
  ...
  switch (draggingJoint.name) {
    ...
    case 'skeleton_9': {
      ...
      jointsMap['skeleton_10'] = {
        x: glyph.tempData['skeleton_10'].x + deltaX,
        y: glyph.tempData['skeleton_10'].y + deltaY / 2 + deltaY / 4,
      }
      jointsMap['skeleton_11'] = {
        x: glyph.tempData['skeleton_11'].x - deltaX,
        y: glyph.tempData['skeleton_11'].y + deltaY / 4,
      }
      jointsMap['skeleton_12'] = {
        x: glyph.tempData['skeleton_12'].x - deltaX,
        y: glyph.tempData['skeleton_12'].y,
    ...
    case 'skeleton_4': {
      ...
      jointsMap['skeleton_6'] = {
        ...
        y: glyph.tempData['skeleton_6'].y + deltaY + deltaY / 2,
      }
      jointsMap['skeleton_7'] = {
      ...
      jointsMap['skeleton_10'] = {
        ...
        y: glyph.tempData['skeleton_10'].y + deltaY + deltaY / 2,
      }
      break
    }
    case 'skeleton_5': {
...
const computeParamsByJoints = (jointsMap) => {
  ...
  const w1 = range(skeleton_7.x - skeleton_9.x, w1_range)
  return {
    h1,
    w1,
  }
...
const updateGlyphByParams = (params, global_params) => {
  ...
  glyph.addRefLine(refline(skeleton_1, skeleton_12))
  glyph.addRefLine(refline(skeleton_1, skeleton_9))
  glyph.addRefLine(refline(skeleton_3, skeleton_5))
  glyph.addRefLine(refline(skeleton_9, skeleton_7))
  glyph.addRefLine(refline(skeleton_12, skeleton_7))
