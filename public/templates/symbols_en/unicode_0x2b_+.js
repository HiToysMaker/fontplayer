  ...
  switch (draggingJoint.name) {
    case 'skeleton_0': {
      ...
      jointsMap['skeleton_2'] = {
        ...
        y: glyph.tempData['skeleton_2'].y + deltaX,
      }
      jointsMap['skeleton_3'] = {
        x: glyph.tempData['skeleton_3'].x,
        y: glyph.tempData['skeleton_3'].y - deltaX,
      }
      break
    }
    case 'skeleton_1': {
    ...
    case 'skeleton_2': {
      jointsMap['skeleton_0'] = {
        x: glyph.tempData['skeleton_0'].x + deltaY,
        y: glyph.tempData['skeleton_0'].y,
      }
      jointsMap['skeleton_1'] = {
        x: glyph.tempData['skeleton_1'].x - deltaY,
        y: glyph.tempData['skeleton_1'].y,
      }
      jointsMap['skeleton_2'] = {
        x: glyph.tempData['skeleton_2'].x,
...
const computeParamsByJoints = (jointsMap) => {
  ...
  const h1 = range(skeleton_3.y - skeleton_2.y, h1_range)
